  ...
  return (
    <div className="min-h-screen bg-black text-green-400 font-mono overflow-x-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8">
        ...
        <section 
          className="bg-gray-900 bg-opacity-70 rounded-lg p-8 mb-8 opacity-0 animate-fadeIn"
          ...
          <div className="grid md:grid-cols-2 gap-6 text-green-100">
            <div>
              ...
              <ul>
                ...
                <li><strong>活動地點：</strong>成功大學、臺南一中</li>
                <li><strong>主辦單位：</strong>SCIST 南臺灣學生資訊社群 </li>
                <li><strong>活動對象：</strong>？？？</li>
        ...
        <section 
          className="bg-gray-900 bg-opacity-70 rounded-lg p-8 opacity-0 animate-fadeIn"
        ...
        <footer 
          className="text-center mt-12 text-green-500 opacity-0 animate-fadeInUp"
