      ...
      <div className="relative z-10">
        ...
        >
          ...
          <div className="grid md:grid-cols-3 gap-8 text-indigo-100">
            {[
              { name: "冰川/陳威達", photo: "/images/陳威達_photo.jpg" },
              { name: "OsGa/黃宥睿", photo: "/images/黃宥睿_photo.jpg" },
              { name: "4Yu/黃士育", photo: "/images/黃士育_photo.jpg" },
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-gray-800 p-4 rounded text-center w-40 hover:scale-105 transform transition"
              >
                <div className="mb-4">
