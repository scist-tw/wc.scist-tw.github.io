...
import instructor1 from '../assets/images/陳威達_photo.jpg';
import instructor2 from '../assets/images/黃宥睿_photo.jpg';
import instructor3 from '../assets/images/黃士育_photo.jpg';
            ...
            <div className="relative z-10">
                ...
                >
                    ...
                    <div className="grid md:grid-cols-3 gap-8 text-indigo-100">
                        {[
                            { name: '冰川/陳威達', photo: instructor1 },
                            { name: 'OsGa/黃宥睿', photo: instructor2 },
                            { name: '4Yu/黃士育', photo: instructor3 },
                            ...
                            >
                                <div className="mb-4 relative group">
                                    ...
                                    />
                                    <div className="absolute inset-0 rounded-full border-2 border-transparent  transition-all duration-300"></div>
                                </div>
