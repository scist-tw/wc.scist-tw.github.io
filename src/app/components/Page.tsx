    ...
    return (
        <div className="bg-black text-indigo-400 font-mono overflow-x-hidden">
            ...
            <div className="relative z-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-6 text-indigo-100">
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><strong>活動地點：</strong>國立成功大學、國立臺南一中</li>
                                <li><strong>主辦單位：</strong>SCIST 南臺灣學生資訊社群</li>
                                <li><strong>活動對象：</strong>全臺國高中生</li>
                                <li><strong>報名費用：</strong>2000元/基本費用；3000元/需住宿者</li>
                                <li><strong>住宿地點：</strong>老曼船長</li>
                            </ul>
                        </div>
                        <div>
                    ...
                    <div className="grid md:grid-cols-3 gap-8 text-indigo-100">
                        {[
                            ...
                            >
                                ...
                                <div className="text-sm text-indigo-400 mt-1">{instructor.topic}</div>
                            </div>
                        ))}
                    </div>
                </section>
                ...
                <section
                    ref={sponsorsRef}
                    className={`max-w-5xl mx-auto bg-gray-900 bg-opacity-90 rounded-xl p-12 my-16 transition-opacity duration-1000 transform ${sponsorsInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}
                >
                    <h2 className="text-3xl mb-6 text-indigo-300 border-b-2 border-indigo-500 pb-2">
                        贊助商</h2>
                    <div className="flex flex-wrap justify-center gap-6">
                        {[
                            ...
                            <div key={index} className="bg-gray-800 shadow-md p-6 rounded text-center w-80 hover:scale-105 transform transition">
                                <div className="mb-6">
                                    <div className="w-64 h-32 mx-auto bg-gray-100 rounded flex items-center justify-center">
                                        <Image src={sponsor.logo} alt={sponsor.name} className="max-h-full max-w-full object-contain" />
                                    </div>
                                </div>
                                <div className="text-lg font-bold mt-3 text-indigo-600" style={{ color: '#f1dcf7' }}>
                                    {sponsor.name}
                                </div>
                            </div>
                        ))}
